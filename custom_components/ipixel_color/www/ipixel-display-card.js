...
`;var S={A:[124,18,17,18,124],B:[127,73,73,73,54],C:[62,65,65,65,34],D:[127,65,65,34,28],E:[127,73,73,73,65],F:[127,9,9,9,1],G:[62,65,73,73,122],H:[127,8,8,8,127],I:[0,65,127,65,0],J:[32,64,65,63,1],K:[127,8,20,34,65],L:[127,64,64,64,64],M:[127,2,12,2,127],N:[127,4,8,16,127],O:[62,65,65,65,62],P:[127,9,9,9,6],Q:[62,65,81,33,94],R:[127,9,25,41,70],S:[70,73,73,73,49],T:[1,1,127,1,1],U:[63,64,64,64,63],V:[31,32,64,32,31],W:[63,64,56,64,63],X:[99,20,8,20,99],Y:[7,8,112,8,7],Z:[97,81,73,69,67],a:[32,84,84,84,120],b:[127,72,68,68,56],c:[56,68,68,68,32],d:[56,68,68,72,127],e:[56,84,84,84,24],f:[8,126,9,1,2],g:[12,82,82,82,62],h:[127,8,4,4,120],i:[0,68,125,64,0],j:[32,64,68,61,0],k:[127,16,40,68,0],l:[0,65,127,64,0],m:[124,4,24,4,120],n:[124,8,4,4,120],o:[56,68,68,68,56],p:[124,20,20,20,8],q:[8,20,20,24,124],r:[124,8,4,4,8],s:[72,84,84,84,32],t:[4,63,68,64,32],u:[60,64,64,32,124],v:[28,32,64,32,28],w:[60,64,48,64,60],x:[68,40,16,40,68],y:[12,80,80,80,60],z:[68,100,84,76,68],0:[62,81,73,69,62],1:[0,66,127,64,0],2:[66,97,81,73,70],3:[33,65,69,75,49],4:[24,20,18,127,16],5:[39,69,69,69,57],6:[60,74,73,73,48],7:[1,113,9,5,3],8:[54,73,73,73,54],9:[6,73,73,41,30]," ":[0,0,0,0,0],".":[0,96,96,0,0],",":[0,128,96,0,0],":":[0,54,54,0,0],";":[0,128,54,0,0],"!":[0,0,95,0,0],"?":[2,1,81,9,6],"-":[8,8,8,8,8],"+":[8,8,62,8,8],"=":[20,20,20,20,20],_:[64,64,64,64,64],"/":[32,16,8,4,2],"\\":[2,4,8,16,32],"(":[0,28,34,65,0],")":[0,65,34,28,0],"[":[0,127,65,65,0],"]":[0,65,65,127,0],"<":[8,20,34,65,0],">":[0,65,34,20,8],"*":[20,8,62,8,20],"#":[20,127,20,127,20],"@":[62,65,93,85,30],"&":[54,73,85,34,80],"%":[35,19,8,100,98],$:[18,42,127,42,36],"'":[0,0,7,0,0],'"':[0,7,0,7,0],"`":[0,1,2,0,0],"^":[4,2,1,2,4],"~":[8,4,8,16,8]};function T(x,e,t,i="#ff6600",s="#111"){let r=[],a=Math.floor((t-7)/2);for(let d=0;d<t;d++)for(let m=0;m<e;m++)r.push(s);let c=x.length*6-1,h=Math.max(1,Math.floor((e-c)/2));for(let d of x){let m=S[d]||S[" "];for(let g=0;g<5;g++)for(let p=0;p<7;p++){let u=m[g]>>p&1,b=h+g,E=a+p;b>=0&&b<e&&E<t&&E>=0&&(r[E*e+b]=u?i:s)}h+=6}return r}function N(x,e,t,i="#ff6600",s="#111"){let n=Math.floor((t-7)/2),a=x.length*6,c=e+a+e,l=[];for(let d=0;d<t;d++)for(let m=0;m<c;m++)l.push(s);let h=e;for(let d of x){let m=S[d]||S[" "];for(let g=0;g<5;g++)for(let p=0;p<7;p++){let u=m[g]>>p&1,b=h+g,E=n+p;b>=0&&b<c&&E<t&&E>=0&&(l[E*c+b]=u?i:s)}h+=6}return{pixels:l,width:c}}var L=class{constructor(e){this.renderer=e}init(e,t){let{width:i,height:s}=this.renderer;switch(e){case"scroll_ltr":case"scroll_rtl":t.offset=0;break;case"blink":t.visible=!0;break;case"snow":case"breeze":t.phases=[];for(let r=0;r<i*s;r++)t.phases[r]=Math.random()*Math.PI*2;break;case"laser":t.position=0;break;case"fade":t.opacity=0,t.direction=1;break;case"typewriter":t.charIndex=0,t.cursorVisible=!0;break;case"bounce":t.offset=0,t.direction=1;break;case"sparkle":t.sparkles=[];for(let r=0;r<Math.floor(i*s*.1);r++)t.sparkles.push({x:Math.floor(Math.random()*i),y:Math.floor(Math.random()*s),brightness:Math.random(),speed:.05+Math.random()*.1});break}}step(e,t){let{width:i,extendedWidth:s}=this.renderer;switch(e){case"scroll_ltr":t.offset-=1,t.offset<=-(s||i)&&(t.offset=i);break;case"scroll_rtl":t.offset+=1,t.offset>=(s||i)&&(t.offset=-i);break;case"blink":t.visible=!t.visible;break;case"laser":t.position=(t.position+1)%i;break;case"fade":t.opacity+=t.direction*.05,t.opacity>=1?(t.opacity=1,t.direction=-1):t.opacity<=0&&(t.opacity=0,t.direction=1);break;case"typewriter":t.tick%3===0&&t.charIndex++,t.cursorVisible=t.tick%10<5;break;case"bounce":t.offset+=t.direction;let r=Math.max(0,(s||i)-i);t.offset>=r?(t.offset=r,t.direction=-1):t.offset<=0&&(t.offset=0,t.direction=1);break;case"sparkle":for(let o of t.sparkles)o.brightness+=o.speed,o.brightness>1&&(o.brightness=0,o.x=Math.floor(Math.random()*i),o.y=Math.floor(Math.random()*this.renderer.height));break}}render(e,t,i,s,r){let{width:o,height:n}=this.renderer,a=s||i||[],c=i||[],l=r||o;for(let h=0;h<n;h++)for(let d=0;d<o;d++){let m,g=d;if(e==="scroll_ltr"||e==="scroll_rtl"||e==="bounce"){for(g=d-(t.offset||0);g<0;)g+=l;for(;g>=l;)g-=l;m=a[h*l+g]||"#111"}else if(e==="typewriter"){let v=(t.charIndex||0)*6;d<v?m=c[h*o+d]||"#111":d===v&&t.cursorVisible?m="#ffffff":m="#111"}else m=c[h*o+d]||"#111";let[p,u,b]=this._hexToRgb(m);if(p>20||u>20||b>20)switch(e){case"blink":t.visible||(p=u=b=17);break;case"snow":{let _=t.phases?.[h*o+d]||0,v=t.tick||0,y=.3+.7*Math.abs(Math.sin(_+v*.3));p*=y,u*=y,b*=y;break}case"breeze":{let _=t.phases?.[h*o+d]||0,v=t.tick||0,y=.4+.6*Math.abs(Math.sin(_+v*.15+d*.2));p*=y,u*=y,b*=y;break}case"laser":{let _=t.position||0,y=Math.abs(d-_)<3?1:.3;p*=y,u*=y,b*=y;break}case"fade":{let _=t.opacity||1;p*=_,u*=_,b*=_;break}}if(e==="sparkle"&&t.sparkles){for(let _ of t.sparkles)if(_.x===d&&_.y===h){let v=Math.sin(_.brightness*Math.PI);p=Math.min(255,p+v*200),u=Math.min(255,u+v*200),b=Math.min(255,b+v*200)}}this.renderer.setPixel(d,h,[p,u,b])}}_hexToRgb(e){if(!e||e==="#111"||e==="#000")return[17,17,17];if(e==="#050505")return[5,5,5];let t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return t?[parseInt(t[1],16),parseInt(t[2],16),parseInt(t[3],16)]:[17,17,17]}};function q(x,e,t){let i,s,r,o=Math.floor(x*6),n=x*6-o,a=t*(1-e),c=t*(1-n*e),l=t*(1-(1-n)*e);switch(o%6){case 0:i=t,s=l,r=a;break;case 1:i=c,s=t,r=a;break;case 2:i=a,s=t,r=l;break;case 3:i=a,s=c,r=t;break;case 4:i=l,s=a,r=t;break;case 5:i=t,s=a,r=c;break}return[i*255,s*255,r*255]}var R=class{constructor(e){this.renderer=e}init(e,t){let{width:i,height:s}=this.renderer;switch(e){case"rainbow":t.position=0;break;case"matrix":let r=[[0,255,0],[0,255,255],[255,0,255]];t.colorMode=r[Math.floor(Math.random()*r.length)],t.buffer=[];for(let n=0;n<s;n++)t.buffer.push(Array(i).fill(null).map(()=>[0,0,0]));break;case"plasma":t.time=0;break;case"gradient":t.time=0;break;case"fire":t.heat=[];for(let n=0;n<i*s;n++)t.heat[n]=0;t.palette=this._createFirePalette();break;case"water":t.current=[],t.previous=[];for(let n=0;n<i*s;n++)t.current[n]=0,t.previous[n]=0;t.damping=.95;break;case"stars":t.stars=[];let o=Math.floor(i*s*.15);for(let n=0;n<o;n++)t.stars.push({x:Math.floor(Math.random()*i),y:Math.floor(Math.random()*s),brightness:Math.random(),speed:.02+Math.random()*.05,phase:Math.random()*Math.PI*2});break;case"confetti":t.particles=[];for(let n=0;n<20;n++)t.particles.push(this._createConfettiParticle(i,s,!0));break}}step(e,t){let{width:i,height:s}=this.renderer;switch(e){case"rainbow":t.position=(t.position+.01)%1;break;case"matrix":this._stepMatrix(t,i,s);break;case"plasma":case"gradient":t.time=(t.time||0)+.05;break;case"fire":this._stepFire(t,i,s);break;case"water":this._stepWater(t,i,s);break;case"stars":for(let r of t.stars)r.phase+=r.speed;break;case"confetti":for(let r=0;r<t.particles.length;r++){let o=t.particles[r];o.y+=o.speed,o.x+=o.drift,o.rotation+=o.rotationSpeed,o.y>s&&(t.particles[r]=this._createConfettiParticle(i,s,!1))}break}}render(e,t){switch(e){case"rainbow":this._renderRainbow(t);break;case"matrix":this._renderMatrix(t);break;case"plasma":this._renderPlasma(t);break;case"gradient":this._renderGradient(t);break;case"fire":this._renderFire(t);break;case"water":this._renderWater(t);break;case"stars":this._renderStars(t);break;case"confetti":this._renderConfetti(t);break}}_renderRainbow(e){let{width:t,height:i}=this.renderer,s=e.position||0;for(let r=0;r<t;r++){let o=(s+r/t)%1,[n,a,c]=q(o,1,.6);for(let l=0;l<i;l++)this.renderer.setPixel(r,l,[n,a,c])}}_stepMatrix(e,t,i){let s=e.buffer,r=e.colorMode,o=.15;s.pop();let n=s[0].map(([a,c,l])=>[a*(1-o),c*(1-o),l*(1-o)]);s.unshift(JSON.parse(JSON.stringify(n)));for(let a=0;a<t;a++)Math.random()<.08&&(s[0][a]=[Math.floor(Math.random()*r[0]),Math.floor(Math.random()*r[1]),Math.floor(Math.random()*r[2])])}_renderMatrix(e){let{width:t,height:i}=this.renderer,s=e.buffer;if(s)for(let r=0;r<i;r++)for(let o=0;o<t;o++){let[n,a,c]=s[r]?.[o]||[0,0,0];this.renderer.setPixel(o,r,[n,a,c])}}_renderPlasma(e){let{width:t,height:i}=this.renderer,s=e.time||0,r=t/2,o=i/2;for(let n=0;n<t;n++)for(let a=0;a<i;a++){let c=n-r,l=a-o,h=Math.sqrt(c*c+l*l),d=Math.sin(n/8+s),m=Math.sin(a/6+s*.8),g=Math.sin(h/6-s*1.2),p=Math.sin((n+a)/10+s*.5),u=(d+m+g+p+4)/8,b=Math.sin(u*Math.PI*2)*.5+.5,E=Math.sin(u*Math.PI*2+2)*.5+.5,_=Math.sin(u*Math.PI*2+4)*.5+.5;this.renderer.setPixel(n,a,[b*255,E*255,_*255])}}_renderGradient(e){let{width:t,height:i}=this.renderer,r=(e.time||0)*10;for(let o=0;o<t;o++)for(let n=0;n<i;n++){let a=(Math.sin((o+r)*.05)*.5+.5)*255,c=(Math.cos((n+r)*.05)*.5+.5)*255,l=(Math.sin((o+n+r)*.03)*.5+.5)*255;this.renderer.setPixel(o,n,[a,c,l])}}_createFirePalette(){let e=[];for(let t=0;t<256;t++){let i,s,r;t<64?(i=t*4,s=0,r=0):t<128?(i=255,s=(t-64)*4,r=0):t<192?(i=255,s=255,r=(t-128)*4):(i=255,s=255,r=255),e.push([i,s,r])}return e}_stepFire(e,t,i){let s=e.heat;for(let r=0;r<t*i;r++)s[r]=Math.max(0,s[r]-Math.random()*10);for(let r=0;r<i-1;r++)for(let o=0;o<t;o++){let n=r*t+o,a=(r+1)*t+o,c=r*t+Math.max(0,o-1),l=r*t+Math.min(t-1,o+1);s[n]=(s[a]+s[c]+s[l])/3.05}for(let r=0;r<t;r++)Math.random()<.6&&(s[(i-1)*t+r]=180+Math.random()*75)}_renderFire(e){let{width:t,height:i}=this.renderer,s=e.heat,r=e.palette;for(let o=0;o<i;o++)for(let n=0;n<t;n++){let a=o*t+n,c=Math.floor(Math.min(255,s[a])),[l,h,d]=r[c];this.renderer.setPixel(n,o,[l,h,d])}}_stepWater(e,t,i){let{current:s,previous:r,damping:o}=e,n=[...r];for(let a=0;a<s.length;a++)r[a]=s[a];for(let a=1;a<i-1;a++)for(let c=1;c<t-1;c++){let l=a*t+c;s[l]=(n[(a-1)*t+c]+n[(a+1)*t+c]+n[a*t+(c-1)]+n[a*t+(c+1)])/2-s[l],s[l]*=o}if(Math.random()<.1){let a=Math.floor(Math.random()*(t-2))+1,c=Math.floor(Math.random()*(i-2))+1;s[c*t+a]=255}}_renderWater(e){let{width:t,height:i}=this.renderer,s=e.current;for(let r=0;r<i;r++)for(let o=0;o<t;o++){let n=r*t+o,a=Math.abs(s[n]),c=Math.min(255,a*2),l=c>200?c:0,h=c>150?c*.8:c*.3,d=Math.min(255,50+c);this.renderer.setPixel(o,r,[l,h,d])}}_renderStars(e){let{width:t,height:i}=this.renderer;for(let s=0;s<i;s++)for(let r=0;r<t;r++)this.renderer.setPixel(r,s,[5,5,15]);for(let s of e.stars){let r=(Math.sin(s.phase)*.5+.5)*255,o=Math.floor(s.x),n=Math.floor(s.y);o>=0&&o<t&&n>=0&&n<i&&this.renderer.setPixel(o,n,[r,r,r*.9])}}_createConfettiParticle(e,t,i){let s=[[255,0,0],[0,255,0],[0,0,255],[255,255,0],[255,0,255],[0,255,255],[255,128,0],[255,192,203]];return{x:Math.random()*e,y:i?Math.random()*t:-2,speed:.2+Math.random()*.3,drift:(Math.random()-.5)*.3,color:s[Math.floor(Math.random()*s.length)],size:1+Math.random(),rotation:Math.random()*Math.PI*2,rotationSpeed:(Math.random()-.5)*.2}}_renderConfetti(e){let{width:t,height:i}=this.renderer;for(let s=0;s<i;s++)for(let r=0;r<t;r++)this.renderer.setPixel(r,s,[10,10,10]);for(let s of e.particles){let r=Math.floor(s.x),o=Math.floor(s.y);if(r>=0&&r<t&&o>=0&&o<i){this.renderer.setPixel(r,o,s.color);let n=Math.abs(Math.sin(s.rotation))*.5+.5,[a,c,l]=s.color;this.renderer.setPixel(r,o,[a*n,c*n,l*n])}}}};function z(x,e,t){let i,s,r,o=Math.floor(x*6),n=x*6-o,a=t*(1-e),c=t*(1-n*e),l=t*(1-(1-n)*e);switch(o%6){case 0:i=t,s=l,r=a;break;case 1:i=c,s=t,r=a;break;case 2:i=a,s=t,r=l;break;case 3:i=a,s=c,r=t;break;case 4:i=l,s=a,r=t;break;case 5:i=t,s=a,r=c;break}return[i*255,s*255,r*255]}var P=class{constructor(e){this.renderer=e}init(e,t){switch(e){case"color_cycle":t.hue=0;break;case"rainbow_text":t.offset=0;break;case"neon":t.glowIntensity=0,t.direction=1,t.baseColor=t.fgColor||"#ff00ff";break}}step(e,t){switch(e){case"color_cycle":t.hue=(t.hue+.01)%1;break;case"rainbow_text":t.offset=(t.offset+.02)%1;break;case"neon":t.glowIntensity+=t.direction*.05,t.glowIntensity>=1?(t.glowIntensity=1,t.direction=-1):t.glowIntensity<=.3&&(t.glowIntensity=.3,t.direction=1);break}}render(e,t,i){let{width:s,height:r}=this.renderer,o=i||[];for(let n=0;n<r;n++)for(let a=0;a<s;a++){let c=o[n*s+a]||"#111",[l,h,d]=this._hexToRgb(c);if(l>20||h>20||d>20)switch(e){case"color_cycle":{let[g,p,u]=z(t.hue,1,.8),b=(l+h+d)/(3*255);l=g*b,h=p*b,d=u*b;break}case"rainbow_text":{let g=(t.offset+a/s)%1,[p,u,b]=z(g,1,.8),E=(l+h+d)/(3*255);l=p*E,h=u*E,d=b*E;break}case"neon":{let g=this._hexToRgb(t.baseColor||"#ff00ff"),p=t.glowIntensity||.5;if(l=g[0]*p,h=g[1]*p,d=g[2]*p,p>.8){let u=(p-.8)*5;l=l+(255-l)*u*.3,h=h+(255-h)*u*.3,d=d+(255-d)*u*.3}break}}this.renderer.setPixel(a,n,[l,h,d])}}_hexToRgb(e){if(!e||e==="#111"||e==="#000")return[17,17,17];if(e==="#050505")return[5,5,5];let t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return t?[parseInt(t[1],16),parseInt(t[2],16),parseInt(t[3],16)]:[17,17,17]}};var f={TEXT:"text",AMBIENT:"ambient",COLOR:"color"},w={fixed:{category:f.TEXT,name:"Fixed",description:"Static display"},scroll_ltr:{category:f.TEXT,name:"Scroll Left",description:"Text scrolls left to right"},scroll_rtl:{category:f.TEXT,name:"Scroll Right",description:"Text scrolls right to left"},blink:{category:f.TEXT,name:"Blink",description:"Text blinks on/off"},breeze:{category:f.TEXT,name:"Breeze",description:"Gentle wave brightness"},snow:{category:f.TEXT,name:"Snow",description:"Sparkle effect"},laser:{category:f.TEXT,name:"Laser",description:"Scanning beam"},fade:{category:f.TEXT,name:"Fade",description:"Fade in/out"},typewriter:{category:f.TEXT,name:"Typewriter",description:"Characters appear one by one"},bounce:{category:f.TEXT,name:"Bounce",description:"Text bounces back and forth"},sparkle:{category:f.TEXT,name:"Sparkle",description:"Random sparkle overlay"},rainbow:{category:f.AMBIENT,name:"Rainbow",description:"HSV rainbow gradient"},matrix:{category:f.AMBIENT,name:"Matrix",description:"Digital rain effect"},plasma:{category:f.AMBIENT,name:"Plasma",description:"Classic plasma waves"},gradient:{category:f.AMBIENT,name:"Gradient",description:"Moving color gradients"},fire:{category:f.AMBIENT,name:"Fire",description:"Fire/flame simulation"},water:{category:f.AMBIENT,name:"Water",description:"Ripple/wave effect"},stars:{category:f.AMBIENT,name:"Stars",description:"Twinkling starfield"},confetti:{category:f.AMBIENT,name:"Confetti",description:"Falling colored particles"},color_cycle:{category:f.COLOR,name:"Color Cycle",description:"Cycle through colors"},rainbow_text:{category:f.COLOR,name:"Rainbow Text",description:"Rainbow gradient on text"},neon:{category:f.COLOR,name:"Neon",description:"Pulsing neon glow"}},I=class{constructor(e){this.renderer=e,this.textEffects=new L(e),this.ambientEffects=new R(e),this.colorEffects=new P(e),this.currentEffect="fixed",this.effectState={}}getEffectInfo(e){return w[e]||w.fixed}getEffectsByCategory(e){return Object.entries(w).filter(([t,i])=>i.category===e).map(([t,i])=>({name:t,...i}))}initEffect(e,t={}){let i=this.getEffectInfo(e);switch(this.currentEffect=e,this.effectState={tick:0,...t},i.category){case f.TEXT:this.textEffects.init(e,this.effectState);break;case f.AMBIENT:this.ambientEffects.init(e,this.effectState);break;case f.COLOR:this.colorEffects.init(e,this.effectState);break}return this.effectState}step(){let e=this.getEffectInfo(this.currentEffect);switch(this.effectState.tick=(this.effectState.tick||0)+1,e.category){case f.TEXT:this.textEffects.step(this.currentEffect,this.effectState);break;case f.AMBIENT:this.ambientEffects.step(this.currentEffect,this.effectState);break;case f.COLOR:this.colorEffects.step(this.currentEffect,this.effectState);break}}render(e,t,i){switch(this.getEffectInfo(this.currentEffect).category){case f.AMBIENT:this.ambientEffects.render(this.currentEffect,this.effectState);break;case f.TEXT:this.textEffects.render(this.currentEffect,this.effectState,e,t,i);break;case f.COLOR:this.colorEffects.render(this.currentEffect,this.effectState,e);break}}isAmbient(e){return this.getEffectInfo(e).category===f.AMBIENT}needsAnimation(e){return e!=="fixed"}},at=Object.entries(w).filter(([x,e])=>e.category===f.TEXT).map(([x])=>x),ct=Object.entries(w).filter(([x,e])=>e.category===f.AMBIENT).map(([x])=>x),lt=Object.entries(w).filter(([x,e])=>e.category===f.COLOR).map(([x])=>x),dt=Object.keys(w);var A=class{constructor(e,t={}){this.container=e,this.width=t.width||64,this.height=t.height||16,this.pixelGap=t.pixelGap||.1,this.buffer=[],this.prevBuffer=[],this._initBuffer(),this._colorPixels=[],this._extendedColorPixels=[],this.extendedWidth=this.width,this.effect="fixed",this.speed=50,this.animationId=null,this.lastFrameTime=0,this._isRunning=!1,this.pixelElements=[],this.svgCreated=!1,this._svg=null,this.effectManager=new I(this)}_initBuffer(){this.buffer=[],this.prevBuffer=[];for(let e=0;e<this.width*this.height;e++)this.buffer.push([0,0,0]),this.prevBuffer.push([-1,-1,-1])}_createSvg(){let t=100/this.width,i=t,s=this.height*i,r=this.pixelGap,o=document.createElementNS("http://www.w3.org/2000/svg","svg");o.setAttribute("viewBox",`0 0 100 ${s}`),o.setAttribute("preserveAspectRatio","xMidYMid meet"),o.style.width="100%",o.style.height="100%",o.style.display="block",this.pixelElements=[];for(let n=0;n<this.height;n++)for(let a=0;a<this.width;a++){let c=document.createElementNS("http://www.w3.org/2000/svg","rect");c.setAttribute("x",a*t),c.setAttribute("y",n*i),c.setAttribute("width",t-r),c.setAttribute("height",i-r),c.setAttribute("rx","0.3"),c.setAttribute("fill","rgb(17, 17, 17)"),o.appendChild(c),this.pixelElements.push(c)}this.container&&this.container.isConnected!==!1&&(this.container.innerHTML="",this.container.appendChild(o)),this._svg=o,this.svgCreated=!0}_ensureSvgInContainer(){return this.container?this._svg&&this._svg.parentNode===this.container?!0:this._svg&&this.container.isConnected!==!1?(this.container.innerHTML="",this.container.appendChild(this._svg),!0):!1:!1}setPixel(e,t,i){if(e>=0&&e<this.width&&t>=0&&t<this.height){let s=t*this.width+e;s<this.buffer.length&&(this.buffer[s]=i)}}clear(){for(let e=0;e<this.buffer.length;e++)this.buffer[e]=[0,0,0]}flush(){this.svgCreated?this._ensureSvgInContainer()||this._createSvg():this._createSvg();for(let e=0;e<this.buffer.length;e++){let t=this.buffer[e],i=this.prevBuffer[e];if(!t||!Array.isArray(t))continue;if(!i||!Array.isArray(i)){this.prevBuffer[e]=[-1,-1,-1];continue}let[s,r,o]=t,[n,a,c]=i;if(s!==n||r!==a||o!==c){let l=this.pixelElements[e];if(l){let h=s>20||r>20||o>20;l.setAttribute("fill",`rgb(${Math.round(s)}, ${Math.round(r)}, ${Math.round(o)})`),h?l.style.filter=`drop-shadow(0 0 2px rgb(${Math.round(s)}, ${Math.round(r)}, ${Math.round(o)}))`:l.style.filter=""}this.prevBuffer[e]=[s,r,o]}}}setData(e,t=null,i=null){this._colorPixels=e||[],t?(this._extendedColorPixels=t,this.extendedWidth=i||this.width):(this._extendedColorPixels=e||[],this.extendedWidth=this.width)}setEffect(e,t=50){let i=this._isRunning;this.effect!==e&&(this.effect=e,this.effectManager.initEffect(e,{speed:t})),this.speed=t,i&&e!=="fixed"&&this.start()}start(){this._isRunning||(this._isRunning=!0,this.lastFrameTime=performance.now(),this._animate())}stop(){this._isRunning=!1,this.animationId&&(cancelAnimationFrame(this.animationId),this.animationId=null)}get isRunning(){return this._isRunning}_animate(){if(!this._isRunning)return;let e=performance.now(),t=500-(this.speed-1)*4.7;e-this.lastFrameTime>=t&&(this.lastFrameTime=e,this.effectManager.step()),this._renderFrame(),this.animationId=requestAnimationFrame(()=>this._animate())}_renderFrame(){this.effectManager.render(this._colorPixels,this._extendedColorPixels,this.extendedWidth),this.flush()}renderStatic(){this.svgCreated||this._createSvg(),this._renderFrame()}setDimensions(e,t){(e!==this.width||t!==this.height)&&(this.width=e,this.height=t,this.extendedWidth=e,this._initBuffer(),this.svgCreated=!1,this.effectManager=new I(this),this.effect!=="fixed"&&this.effectManager.initEffect(this.effect,{speed:this.speed}))}setContainer(e){e!==this.container&&(this.container=e,this._svg&&e&&(e.innerHTML="",e.appendChild(this._svg)))}destroy(){this.stop(),this.pixelElements=[],this._svg=null,this.svgCreated=!1}};function j(x,e,t,i=1){let r=100/x,o=r,n=e*o,a=i*.1,c="";for(let l=0;l<e;l++)for(let h=0;h<x;h++){let d=t[l*x+h]||"#111",g=d!=="#111"&&d!=="#000"&&d!=="#1a1a1a"&&d!=="#050505"?`filter:drop-shadow(0 0 2px ${d});`:"";c+=`<rect x="${h*r}" y="${l*o}" width="${r-a}" height="${o-a}" fill="${d}" rx="0.3" style="${g}"/>`}return`
    <svg viewBox="0 0 100 ${n}" preserveAspectRatio="xMidYMid meet" style="width:100%;height:100%;display:block;">
      ${c}
    </svg>`}var V="iPIXEL_DisplayState",U={text:"",mode:"text",effect:"fixed",speed:50,fgColor:"#ff6600",bgColor:"#000000",lastUpdate:0};function J(){try{let x=localStorage.getItem(V);if(x)return JSON.parse(x)}catch(x){console.warn("iPIXEL: Could not load saved state",x)}return{...U}}function Y(x){try{localStorage.setItem(V,JSON.stringify(x))}catch(e){console.warn("iPIXEL: Could not save state",e)}}window.iPIXELDisplayState||(window.iPIXELDisplayState=J());function G(){return window.iPIXELDisplayState}function M(x){return window.iPIXELDisplayState={...window.iPIXELDisplayState,...x,lastUpdate:Date.now()},Y(window.iPIXELDisplayState),window.dispatchEvent(new CustomEvent("ipixel-display-update",{detail:window.iPIXELDisplayState})),window.iPIXELDisplayState}var F=new Map,$=class extends k{constructor(){super(),this._renderer=null,this._displayContainer=null,this._lastState=null,this._cachedResolution=null,this._rendererId=null,this._handleDisplayUpdate=e=>{this._updateDisplay(e.detail)},window.addEventListener("ipixel-display-update",this._handleDisplayUpdate)}connectedCallback(){this._rendererId||(this._rendererId=`renderer_${Date.now()}_${Math.random().toString(36).substr(2,9)}`),F.has(this._rendererId)&&(this._renderer=F.get(this._rendererId))}disconnectedCallback(){window.removeEventListener("ipixel-display-update",this._handleDisplayUpdate),this._renderer&&this._rendererId&&(this._renderer.stop(),F.set(this._rendererId,this._renderer))}_getResolutionCached(){let[e,t]=this.getResolution();if(e>0&&t>0&&e!==64){this._cachedResolution=[e,t];try{localStorage.setItem("iPIXEL_Resolution",JSON.stringify([e,t]))}catch{}}if(this._cachedResolution)return this._cachedResolution;try{let i=localStorage.getItem("iPIXEL_Resolution");if(i){let s=JSON.parse(i);if(Array.isArray(s)&&s.length===2)return this._cachedResolution=s,s}}catch{}return this._config?.width&&this._config?.height?[this._config.width,this._config.height]:[e||64,t||16]}_updateDisplay(e){if(!this._displayContainer)return;let[t,i]=this._getResolutionCached(),s=this.isOn();if(this._renderer?(this._renderer.setContainer(this._displayContainer),(this._renderer.width!==t||this._renderer.height!==i)&&this._renderer.setDimensions(t,i)):(this._renderer=new A(this._displayContainer,{width:t,height:i}),this._rendererId&&F.set(this._rendererId,this._renderer)),!s){this._renderer.stop();let p=T("",t,i,"#111","#050505");this._displayContainer.innerHTML=j(t,i,p);return}let r=e?.text||"",o=e?.effect||"fixed",n=e?.speed||50,a=e?.fgColor||"#ff6600",c=e?.bgColor||"#111",l=e?.mode||"text",h=r,d=a;if(l==="clock"?(h=new Date().toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!1}),d="#00ff88"):l==="gif"?(h="GIF",d="#ff44ff"):l==="rhythm"&&(h="***",d="#44aaff"),w[o]?.category==="ambient")this._renderer.setData([],[],t);else{let p=h.length*6;if((o==="scroll_ltr"||o==="scroll_rtl"||o==="bounce")&&p>t){let{pixels:b,width:E}=N(h,t,i,d,c),_=T(h,t,i,d,c);this._renderer.setData(_,b,E)}else{let b=T(h,t,i,d,c);this._renderer.setData(b)}}this._renderer.setEffect(o,n),o==="fixed"?(this._renderer.stop(),this._renderer.renderStatic()):this._renderer.start()}render(){if(!this._hass)return;let[e,t]=this._getResolutionCached(),i=this.isOn(),s=this._config.name||this.getEntity()?.attributes?.friendly_name||"iPIXEL Display",r=G(),n=this.getEntity()?.state||"",c=this.getRelatedEntity("select","_mode")?.state||r.mode||"text",l=r.text||n,h=r.effect||"fixed",d=r.speed||50,m=r.fgColor||"#ff6600",g=r.bgColor||"#111",u=w[h]?.category==="ambient",b=Object.entries(w).filter(([v,y])=>y.category==="text").map(([v,y])=>`<option value="${v}">${y.name}</option>`).join(""),E=Object.entries(w).filter(([v,y])=>y.category==="ambient").map(([v,y])=>`<option value="${v}">${y.name}</option>`).join(""),_=Object.entries(w).filter(([v,y])=>y.category==="color").map(([v,y])=>`<option value="${v}">${y.name}</option>`).join("");this.shadowRoot.innerHTML=`
      <style>${C}
          ...
          <div class="display-container">
            ...
            <div class="display-footer">
              ...
              <span>
                ...
                ${i&&h!=="fixed"?`<span class="effect-badge">${w[h]?.name||h}</span>`:""}
              </span>
            </div>
          </div>
        </div>
      </ha-card>`,this._displayContainer=this.shadowRoot.getElementById("display-screen"),this._updateDisplay({text:l,effect:h,speed:d,fgColor:m,bgColor:g,mode:c}),this._attachPowerButton()}_attachPowerButton(){this.shadowRoot.getElementById("power-btn")?.addEventListener("click",()=>{let e=this._switchEntityId;if(!e){let t=this.getRelatedEntity("switch");t&&(this._switchEntityId=t.entity_id,e=t.entity_id)}if(e&&this._hass.states[e])this._hass.callService("switch","toggle",{entity_id:e});else{let t=Object.keys(this._hass.states).filter(r=>r.startsWith("switch.")),i=this._config.entity?.replace(/^[^.]+\./,"").replace(/_?(text|display|gif_url)$/i,"")||"",s=t.find(r=>r.includes(i.substring(0,10)));s?(this._switchEntityId=s,this._hass.callService("switch","toggle",{entity_id:s})):console.warn("iPIXEL: No switch found. Entity:",this._config.entity,"Available:",t)}})}static getConfigElement(){return document.createElement("ipixel-simple-editor")}static getStubConfig(){return{entity:""}}};var B=class extends k{render(){if(!this._hass)return;let e=this.isOn();this.shadowRoot.innerHTML=`
      <style>${C}</style>
      <ha-card>
        <div class="card-content">
    ...
    `}_buildAmbientEffectOptions(){return Object.entries(w).filter(([e,t])=>t.category===f.AMBIENT).map(([e,t])=>`<option value="${e}">${t.name}</option>`).join("")}_buildAmbientGrid(){let e=this._selectedAmbient||"rainbow";return Object.entries(w).filter(([t,i])=>i.category===f.AMBIENT).map(([t,i])=>`
